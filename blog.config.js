...
const BLOG = {
  AUTHOR: 'George', // 作者
  BIO: '一个普通的技术宅', // 作者简介
  LINK: 'https://georgeshare.vercel.app/', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '3a8c3fcefa914f008bb1248df4ac133', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/Conor-Xia',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOHzy8mA', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOHzy8mM4CQzOz', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || '3757a02c-b053-45f6-ad3c-1dcf94ac31a0', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
